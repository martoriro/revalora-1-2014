 ...
 * @author sylar
 */
public class EmailInbox extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Email> receivedEmailList = emailSessionBean.readMailImap();
        request.setAttribute("receivedEmailList", receivedEmailList); 
